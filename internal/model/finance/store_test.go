...
var sampleEntries = []Entry{
	{Description: "e1", TargetAmount: 1, Type: ExpenseEntry, Date: getTime("2025-01-01 00:00:00")}, // 1
	...
	{Description: "e4", TargetAmount: 4, Type: ExpenseEntry, Date: getTime("2025-01-04 00:00:00")},
	{Description: "e5", TargetAmount: 5, Type: ExpenseEntry, Date: getTime("2025-01-05 00:00:00"),
		TargetAccountID: 2, TargetAccountName: "acc2"},
	{Description: "e6", TargetAmount: 6, Type: ExpenseEntry, Date: getTime("2025-01-06 00:00:00"),
		TargetAccountID: 1, TargetAccountName: "acc1"},
	{Description: "e7", TargetAmount: 7, Type: ExpenseEntry, Date: getTime("2025-01-07 00:00:00")},
	{Description: "e8", TargetAmount: 8, Type: ExpenseEntry, Date: getTime("2025-01-08 00:00:00"),
		TargetAccountID: 2, TargetAccountName: "acc2"},
	{Description: "e9", TargetAmount: 9, Type: ExpenseEntry, Date: getTime("2025-01-09 00:00:00")},
	{Description: "e10", TargetAmount: 10, Type: TransferEntry, Date: getTime("2025-01-10 00:00:00"),
		TargetAccountID: 2, TargetAccountName: "acc2", OriginAccountID: 1, OriginAccountName: "acc1"},
	{Description: "e11", TargetAmount: 10, Type: ExpenseEntry, Date: getTime("2025-01-11 00:00:00")},
	{Description: "e12", TargetAmount: 10, Type: ExpenseEntry, Date: getTime("2025-01-12 00:00:00")},
	{Description: "e13", TargetAmount: 10, Type: ExpenseEntry, Date: getTime("2025-01-13 00:00:00")},
	{Description: "e14", TargetAmount: 10, Type: ExpenseEntry, Date: getTime("2025-01-14 00:00:00")},
	{Description: "e14", TargetAmount: 10, Type: ExpenseEntry, Date: getTime("2025-01-15 00:00:00")},
	{Description: "e15", TargetAmount: 10, Type: ExpenseEntry, Date: getTime("2025-01-16 00:00:00")},
}
