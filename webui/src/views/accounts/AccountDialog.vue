...
const allAccountTypeOptions = [
    ...
    { value: ACCOUNT_TYPES.RESTRICTED_STOCK, label: ACCOUNT_TYPE_LABELS[ACCOUNT_TYPES.RESTRICTED_STOCK] },
    { value: ACCOUNT_TYPES.LENT, label: ACCOUNT_TYPE_LABELS[ACCOUNT_TYPES.LENT] },
    { value: ACCOUNT_TYPES.PENSION, label: ACCOUNT_TYPE_LABELS[ACCOUNT_TYPES.PENSION] },
    { value: ACCOUNT_TYPES.PREPAID_EXPENSE, label: ACCOUNT_TYPE_LABELS[ACCOUNT_TYPES.PREPAID_EXPENSE] },
]
